...
def get_essays_and_scores():
    root_dir = '/home/nam/Desktop/AspiringMinds/lstm_datafiles/Essay_Data/'
    store_file_corpus = '/home/nam/Desktop/AspiringMinds/lstm_datafiles/essays.txt'
    store_file_scores = '/home/nam/Desktop/AspiringMinds/lstm_datafiles/grammar_scores.txt'
    ...
    for file_name in os.listdir(root_dir):
        ...
        grammar_scores1 = pandas_data['Grammar_1']
        grammar_scores2 = pandas_data['Grammar_2']
        for essay, grammar_score1, grammar_score2 in zip(essays, grammar_scores1, grammar_scores2):
            ...
            essay = ' '.join(essay)
            average_grammar_score = (grammar_score1+grammar_score2)/2.0
            if average_grammar_score < 0.0:
                print grammar_score1
                print grammar_score2
                print essay
                print average_grammar_score
                break
            pickle.dump(essay,fp)
            pickle.dump(average_grammar_score,wp)
    fp.close()
    wp.close()
...
#                treebank_pos_dict[pos] = 1
    ...
    new_corpus = list()
    fp = open('/home/nam/Desktop/AspiringMinds/lstm_datafiles/lstm_tagged_corpus.txt','w')
    for idx,essay in enumerate(essays):
        print idx
        tagged = pos_tag(word_tokenize(essay))
        new_essay = list()
